...
public class TestHBaseAbstractRecordReader {
   ...
   public void  testAbstractRecordReader(){
       ...
       funcArgs.add(new SchemaPath("value"));
       funcArgs.add(new ValueExpressions.LongExpression(1000l));
       FunctionCall func=new FunctionCall(funcDef,funcArgs);
       filters.add(func);
       NamedExpression e1=new NamedExpression(new SchemaPath("uid"),new FieldReference("uid"));
       NamedExpression e2=new NamedExpression(new SchemaPath("event0"),new FieldReference("event0"));
       NamedExpression e3=new NamedExpression(new SchemaPath("value"),new FieldReference("value"));
