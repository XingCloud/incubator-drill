        ...
        public void messageReceived(ChannelHandlerContext ctx, InboundRpcMessage msg) throws Exception {
            ...
            switch (msg.mode) {
                ...
                case RESPONSE:
                    ...
                    Method method = m.getDefaultInstanceForType().getClass().getMethod("parseFrom",new Class[]{InputStream.class});

                    Object value = method.invoke(null,new Object[]{new ByteBufInputStream(msg.pBody, msg.pBody.readableBytes())}) ;
                    rpcFuture.set(value);
...
//  }
    ...
    public static <T> T get(ByteBuf pBody, Class<T> parser) throws RpcException {
        try {
            ...
            return (T) parseFrom.invoke(null, new Object[]{is});
        }
        catch (Exception e) {
