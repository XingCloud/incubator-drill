...
public class MysqlScanPOP extends AbstractGroupScan implements GroupScan, SubScan {


  private final List<MysqlReadEntry> entries;
  ...
  public List<MysqlReadEntry> getEntries() {
    return entries;
  }
