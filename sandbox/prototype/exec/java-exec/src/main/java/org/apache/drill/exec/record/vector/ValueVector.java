 ...
 */
public interface ValueVector<T extends ValueVector<T>> extends Closeable, DrillValue {
     ...
     *
     * @param valueCount The number of possible values which should be contained in this vector.
     */
    ...
    public abstract void setField(MaterializedField field);
