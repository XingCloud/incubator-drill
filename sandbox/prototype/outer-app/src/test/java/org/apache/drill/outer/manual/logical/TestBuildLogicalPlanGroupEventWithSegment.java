 ...
 * Package: org.apache.drill.outer.manual.logical
 */
public class TestBuildLogicalPlanGroupEventWithSegment extends LogicalTestBase {
  ...
  public void buildLogical1() throws Exception {
    ...
    LogicalPlan logicalPlan = buildStaticLogicalPlanManually(c, "age", "visit.*", "20130701", segmentMap,
