...
public class ByteUtils {
   ...
   */
  public static String toString(final byte[] b1, String sep, final byte[] b2) throws UnsupportedEncodingException {
   ...
   * @return the int value
   * @throws IllegalArgumentException if length is not {@link #SIZEOF_INT} or if there's not enough room in the array at
   ...
   * @return the short value
   * @throws IllegalArgumentException if length is not {@link #SIZEOF_SHORT} or if there's not enough room in the array
   *                                  at the offset indicated.
   */
   ...
   */
  public static byte[][] toByteArrays(final String[] t) throws UnsupportedEncodingException {
    byte[][] result = new byte[t.length][];
    for (int i = 0; i < t.length; i++) {
      result[i] = ByteUtils.toBytes(t[i]);
    }
    return result;
  }
   ...
   */
  public static byte[][] toByteArrays(final String column) throws UnsupportedEncodingException {
  ...
  public static void main(String[] args) throws UnsupportedEncodingException {
    String randomString = "行云";
    System.out.println("None ascii string is " + randomString);
    byte[] stringBytes = randomString.getBytes();
    System.out.println("None ascii string byte array is " + Arrays.toString(stringBytes));
