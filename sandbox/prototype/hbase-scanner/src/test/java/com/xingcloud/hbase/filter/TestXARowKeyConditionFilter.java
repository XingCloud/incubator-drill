...
public class TestXARowKeyConditionFilter {
    ...
    public void testFilter() throws IOException {
        ...
        Scan scan=new Scan();
        scan.setStartRow(ByteUtils.toBytesBinary("20130101"));
        scan.setStopRow(ByteUtils.toBytesBinary("20130103visit.\\xFF"));
        ...
        filterConditionList.add(new RowKeyFilterRange("20130103b","20130103d"));
