...
public class HFileScanner implements DataScanner {
    ...
    private void initColFamily(HRegionInfo hRegionInfo, String familyName) {
        ...
        HTableDescriptor desc =hRegionInfo.getTableDesc();
    ...
    private void initKVScanners(Scan scan) {
        ...
        try {
            ...
            for (Map.Entry<byte[], NavigableSet<byte[]>> entry :
                ...
                //StoreScanner storeScanner=new StoreScanner(null,scanInfo,scan,scanners, StoreScanner.ScanType.USER_SCAN,new Long(0),HConstants.LATEST_TIMESTAMP);
