...
public final class PlatformDependent {
    ...
    private static boolean hasUnsafe0() {
        ...
        if (SystemPropertyUtil.contains("io.netty.tryUnsafe")) {
            ...
            tryUnsafe = SystemPropertyUtil.getBoolean("org.jboss.xingcloud.tryUnsafe", true);
        }

        if (!tryUnsafe) {
            logger.debug("sun.misc.Unsafe: unavailable (io.netty.tryUnsafe/org.jboss.xingcloud.tryUnsafe)");
            return false;
        }
